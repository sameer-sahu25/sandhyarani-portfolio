      ...
      <div className="container max-w-2xl">
        ...
        >
          ...
          <div className="mt-6 flex justify-center">
            <a 
              ...
              className="flex items-center gap-2 text-primary hover:text-primary/80 transition-colors duration-300 font-medium bg-primary/5 px-4 py-2 rounded-full border border-primary/10"
            >
              <Mail size={16} />
              <span className="text-sm">sandhyaaa.0122@gmail.com</span>
            </a>
          </div>
        </motion.div>
        ...
        >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-primary text-primary-foreground font-medium text-sm hover:opacity-90 transition-opacity glow-lavender disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {mutation.isPending ? (
              <>
